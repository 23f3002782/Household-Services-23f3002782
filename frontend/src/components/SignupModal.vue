		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body px-5 py-4">
					...
					>
						<div class="mb-3">
							<label for="profEmail" class="form-label"
								>Email address</label
							>
							<input
								type="email"
						...
						<div class="mb-3">
							<label for="profName" class="form-label"
								>Full Name</label
							>
							<input
								type="text"
						...
						<div class="mb-3">
							<label for="profService" class="form-label"
								>Service Type</label
							>
							<select
								class="form-select"
						...
						<div class="mb-3">
							<label for="profPassword" class="form-label"
								>Password</label
							>
							<input
								type="password"
...
<script setup>
	...
	const handleProfessionalSignup = async () => {
		const result = await authStore.professionalSignup(
